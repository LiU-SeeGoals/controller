...
func NewplanCollide(team info.Team) *planCollide {
	return &planCollide{
		planCore: planCore{
			team: team,
		},
...
// 	// Yellow team
// 	slowBrainYellow := slow_brain.NewplanCollide(info.Yellow)
